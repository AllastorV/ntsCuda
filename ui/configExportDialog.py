...
class Ui_TemplateConfigDialog(object):
    def setupUi(self, TemplateConfigDialog):
        ...
        self.copyConfigButton.setGeometry(QtCore.QRect(10, 290, 280, 60))
